...
export const Button: React.FC<ButtonProps> = ({
  ...
  const variants = {
    ...
    outline: 'border border-medium bg-surface text-primary hover:bg-surface-secondary focus:ring-primary',
    ghost: 'text-secondary hover:text-primary hover:bg-surface-secondary focus:ring-primary',
  };
